                ...
                <form onSubmit={submitHandler} className="flex flex-col mt-20  gap-x-7 py-10  w-[600px]  rounded-lg  border bg-richblack-200 text-white mx-auto">
                    ...
                    <div className="w-full ml-32">
                        ...
                        <label htmlFor="password" className="w-full relative">
                            <p className="text-[0.857rem] text-richblack-5 mb-1 leading-[1.385rem]">Create  Passsword<sup className=""> *</sup></p>
                            <input
                                className="bg-richblack-800 text-black rounded-[0.8rem] text-richblack-5 w-[60%] p-[12px] "
                            ...
                            {/* <span
                                ...
                                {
                                    hidden ? (<AiOutlineEyeInvisible></AiOutlineEyeInvisible>) : (<p>Visible</p>)
                                }
                            </span> */}

                            <span className=" absolute bottom-0 right-2 text-black" onClick={hiddenHandler}>{
                                hidden ? <AiOutlineEyeInvisible></AiOutlineEyeInvisible> : <AiOutlineEye></AiOutlineEye>
                            }
                            </span>
                        ...
                        <label htmlFor="Confirm" className="w-full relative">
                            <p className="text-[0.857rem] text-richblack-5 mb-1 leading-[1.385rem]">Confirm Password<sup className=""> *</sup></p>
                            <input
                                className="bg-richblack-800 text-black rounded-[0.8rem] text-richblack-5 w-[60%] p-[12px] "
                            ...
                            <span className=" absolute bottom-0 right-2 text-black" onClick={ConHiddenHandler}>{
                                Conhidden ? <AiOutlineEyeInvisible></AiOutlineEyeInvisible> : <AiOutlineEye></AiOutlineEye>
                            }
                            </span>
                            {/* <span
                                className="absolute text-white right-3 top-[40px] cursor-pointer"
